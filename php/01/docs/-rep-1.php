...
<script>
    var colors = ['#6E1010','#29306F','#056819','#7C4912','#670661','#138895','#47245F','#925428','#245018','#BBBB03','#6E1010','#29306F','#056819','#7C4912','#670661','#138895','#47245F','#925428','#245018','#BBBB03']
    var chart = new Highcharts.Chart({
        chart: {
            renderTo: 'container',
            type: 'column'
        },
	   title:{text:"GRÁFICOS DE SOLICITUDES POR DEPENDENCIAS"},
...
series:[{data:[
		<?php 
			...
			while ($fila = mysql_fetch_object($result)) {
		 ?>
                {name: '<?php echo $fila->grupo; ?>',color: colors[<?php echo $i; ?>],y: <?php echo $fila->sumid; ?>,dataLabels: {enabled: true,align: 'center',crop: false,style: {fontWeight: 'bold'}}}
<?php
		if ( ($i+1) != $row ){
			echo ",";
		}
...
?>
<hr>
<p>Descargar archivo de datos en <a href='http://ed.tabascoweb.com/php/01/docs/<?php echo $fileout; ?>'>MS Excel</a></p>  
