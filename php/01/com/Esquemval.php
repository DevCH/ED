...
function tablaDeElementos(responseText, statusText, xhr, $form){
	...
	$.post(och.getValue(0)+"getEC/", { o:och.index, t:16, p:4,c:q+"|"+oBy+orderBy,from:oPag.currentPage, cantidad:oPag.CantidadPagina },
		function(json){
			//alert(json.length);
...
function cargarRegistrosLeidos(json){
	...
	$(".delCurrentItem").on('click',function(event){
			...
			$.post(och.getValue(0)+"getEC/", { o:och.index, t:2, p:2, c:ind },
 				function(json){
				     if (json[0].msg=="OK"){
