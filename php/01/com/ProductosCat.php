...
function getMedidas(){	
	$.post(och.getValue(0)+"getEC/", { o:och.index, t:200, p:0 },
		function(json){
...
function getProductos(){	
	$.post(och.getValue(0)+"getEC/", { o:och.index, t:300, p:0 },
		function(json){
			if (json.length<=0) { return false;}
...
function tablaDeElementos(){
	...
	$.post(och.getValue(0)+"getEC/", { o:och.index, t:20, p:4,c:oBy+orderBy,from:oPag.currentPage, cantidad:oPag.CantidadPagina  },
		function(json){
...
function tablaDeElementosFiltrados(form){
	...
	$.post(och.getValue(0)+"getEC/", { o:och.index, t:5, p:4,c:oBy+orderBy+"|"+queryString,from:oPag.currentPage, cantidad:oPag.CantidadPagina },
		function(json){
...
function invocarFormularioDomFis(form){
	...
	$.post(och.getValue(0)+"getEC/", { o:0, c:queryString, t:11, p:1 },
 	function(json){
		var q = json[0].msg;
...
function pintaData(){
	$.post(och.getValue(0)+"getEC/", { o:-1, t:0, p:0,c:iduser },
		function(json){
			if (json.length==0) {
				     iduser=0;
					return false;
