...
function getCat(){
	...
	$("#div1em").html(getPreloader());
	$.post(och.getValue(0)+"getEC/", { o:och.index, t:1, p:0 },
 		function(json){
			if (json.length<=0) { return false;}
...
*/	
	...
	$(".div1em").html(getPreloader());	
	$(".listHasta").html("");	
	$.post(och.getValue(0)+"getEC/", { o:och.index, c:d, t:2, p:0 },
 		function(json){
...
function setAsigOpcToGpo(){
	...
	var d = x+"."+y;
	//alert(d);
	$.post(och.getValue(0)+"getEC/", { o:och.index, c:d, t:10, p:1 },
 		function(json){
...
function deleteOpcFromGpo(){
	...
	$.post(och.getValue(0)+"getEC/", { o:och.index, c:x, t:20, p:1 },
 		function(json){
			if (json.length<=0 && json[0].msg=="Error") { $(".div1em").html(""); return false;}
				getCatAsigToGpo();
 	}, "json");
